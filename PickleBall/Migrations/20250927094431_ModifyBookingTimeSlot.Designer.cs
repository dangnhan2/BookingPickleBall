...
namespace PickleBall.Migrations
{
    ...
    [Migration("20250927094431_ModifyBookingTimeSlot")]
    partial class ModifyBookingTimeSlot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PickleBall.Models.BookingTimeSlots", b =>
                {
                    ...
                    b.Property<Guid>("CourtTimeSlotCourtID")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CourtTimeSlotTimeSlotID")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CourtTimeSlotCourtID", "CourtTimeSlotTimeSlotID");
            ...
            modelBuilder.Entity("PickleBall.Models.BookingTimeSlots", b =>
                {
                    ...
                    b.HasOne("PickleBall.Models.CourtTimeSlot", "CourtTimeSlot")
                        .WithMany("BookingTimeSlots")
                        .HasForeignKey("CourtTimeSlotCourtID", "CourtTimeSlotTimeSlotID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Booking");

                    b.Navigation("CourtTimeSlot");
                });
